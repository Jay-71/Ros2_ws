...
def generate_launch_description():
    ...
    # UPDATED: Pointing to the new campus_challenge.sdf world
    default_world = os.path.join(description_package_share, 'worlds', 'campus_challenge.sdf')
    ...
    spawn_entity = Node(
                ...
                arguments=["-topic", 'robot_description',
                           ...
                           '-y', '2.0',
                           '-z', '0.07',
                           '-Y', '1.57'], # 1.57 radians (90 degrees) points the robot North
                output="screen"
                )
    ...
    set_gz_resource_path = SetEnvironmentVariable(
        ...
        value=[os.path.join(get_package_share_directory(description_package), '..')]
    )
